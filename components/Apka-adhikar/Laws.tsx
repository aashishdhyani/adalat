...
const dots: React.CSSProperties = {
  backgroundImage:
    "radial-gradient(circle, rgba(44,26,8,0.045) 1px, transparent 1px)",
...
const ACCENTS: Record<
  string,
  { accent: string; card: string; bdr: string; label: string; icon: string }
> = {
  articles: {
    accent: T.purple,
    card: "#f4f0f8",
  ...
  suraksha: {
    ...
    card: "#f0f4f8",
    bdr: "#90b0d0",
    label: "Nagarik Suraksha Sanhita",
    icon: "🛡️",
  },
  nyay: {
    accent: T.green,
    ...
    if (selected === "articles") {
      return paginate(data as any[]).map((a: any, i: number) => (
        <div
          ...
          style={{
            background: ac!.card,
            border: `2px solid ${ac!.bdr}`,
            borderRadius: 10,
            boxShadow: `4px 4px 0 ${ac!.bdr}`,
            padding: "18px 20px",
            marginBottom: 16,
            position: "relative",
            overflow: "hidden",
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            {Object.entries(entry.laws).map(([topic, law]: any) => (
              <SubCard key={topic}>
                ...
                >
                  <strong style={{ color: T.text }}>Act:</strong> {law.act_name}
                </p>
                <p
                  style={{
                    fontSize: 12,
    ...
    <div style={{ minHeight: "100vh", background: T.bg, position: "relative" }}>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
            ...
            {[T.saffron, T.gold, T.greenLt].map((c, i) => (
              <div
                ...
                style={{
                  ...
                  background: c,
                  borderRadius: "50%",
                  animation: `blink 1.4s ${i * 0.4}s infinite`,
                }}
              />
            ))}
          </div>
        ...
        >
              ...
              {Object.keys(lawFiles).map((key) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <span style={{ fontSize: 18, zIndex: 1, flexShrink: 0 }}>
                      {a.icon}
                    </span>
                    <div style={{ zIndex: 1, minWidth: 0 }}>
                      ...
                      <div
                        style={{
                          fontFamily: "'Press Start 2P',monospace",
                          fontSize: 6,
                          color: isActive ? "rgba(255,255,255,0.65)" : T.muted,
                          marginTop: 2,
                        }}
                      >
                        {key.toUpperCase()}
              ...
              {Array.from({ length: 20 }).map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    width: 26,
                    height: 6,
                    background: i % 2 === 0 ? T.wood : T.woodLt,
                    borderRight: `1px solid ${T.woodDark}`,
                  }}
                />
              ))}
            </div>
          ...
          {/* ── MAIN CONTENT ── */}
          <div
            style={{ flex: 1, padding: "24px 28px 48px", overflowY: "auto" }}
          >
            ...
            <div style={{ animation: "fadeUp 0.3s ease" }}>{renderData()}</div>
